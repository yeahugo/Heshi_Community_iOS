...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row < self.feedsTableView.resultArray.count) {
        [cell reload:[self.feedsTableView.resultArray objectAtIndex:indexPath.row] tableView:tableView cellForRowAtIndexPath:indexPath feedStyle:[self.feedsTableView.feedStyleDictionary valueForKey:[NSString stringWithFormat:@"%d",(int)indexPath.row]]];
