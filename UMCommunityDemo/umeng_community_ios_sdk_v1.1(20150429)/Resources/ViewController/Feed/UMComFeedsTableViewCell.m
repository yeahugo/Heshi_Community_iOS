...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UMComMutiStyleTextView *commentStyleView = [self.feedStyle.commentStyleView objectAtIndex:indexPath.row];
    ...
    [cell.textView setMutiStyleTextViewProperty:[self.feedStyle.commentStyleView objectAtIndex:indexPath.row]];
    ...
    cell.textView.clickOnlinkText = ^(UMComMutiTextRun *run){
        if ([run isKindOfClass:[UMComMutiTextRunClickUser class]]) {
            ...
            [[UMComReplyAction action] performActionAfterLogin:nil viewController:self.tableView.viewController completion:^(NSArray *data, NSError *error) {
                [(UMComFeedsTableView *)self.tableView presentEditView:comment selectedCell:self];
            }];
        }
    };
